...
public class MyCustomAdapter extends ArrayAdapter<CountryModel>
{
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        TextView tvCountryName=view.findViewById(R.id.tvCountryName2);
        ImageView imageView=view.findViewById(R.id.imgFlag1);
        ...
        Filter filter=new Filter() {
            ...
            protected FilterResults performFiltering(CharSequence constraint) {
                ...
                else
                {
                    ...
                    for (CountryModel itemModel:countryModelListFiltered)
                    {
                        if (itemModel.getCountry().toLowerCase().contains(searchStr.toLowerCase()))
                        {
